...
public class PersonaTest {
		...
		public void setUp() throws Exception {
			...
			personaConDatos = new Profesor("Jhon", "Snow", "NoSÈNada");
		...
		public void testPersonaConDatos() {
			...
			assertEquals("NoSÈNada", ((Profesor) personaConDatos).getIosfa());
		}
		@Test
		public void testEqualsEnSet_add_true() {
			...
			System.out.println("ac· sÌ agrega la persona NN:");
			System.out.println("\nset ="+setPersonas);
		}	
		@Test
		public void testEqualsEnSet_add_false() {
			assertFalse(setPersonas.add(personaNN));
			System.out.println("ac· no agrega la persona NN:");
			System.out.println("\nset ="+setPersonas);
		}	
		@Test
